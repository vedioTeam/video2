...
//  videoPlay
//
//  Created by Wrappers Zhang on 2018/5/15.
...
- (void)setuoUI {
    ...
    _loginButton.backgroundColor = [UIColor colorWithHexString:@"#EE82EE"];
    ...
    [_loginButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_passwordTextfield.mas_bottom).offset(50);
